...
- **Your Progress is Synced Securely (Optional):** Your game progress is saved on your device. If you choose to sign in with Google Play Games, your progress (score, unlocked items, etc.) is also saved to Google's secure cloud. This allows you to sync your progress across devices.

- **Ads Keep the App Free:** To support the App's development, we show ads through Google AdMob. You can make a one-time Premium purchase to remove ads permanently or optionally watch a rewarded ad to remove them for 24 hours.

- **In-App Purchases are Handled by Google:** All purchases, like the Premium upgrade or sticker packs, are processed securely through the Google Play Store. We never see or store your payment information.

- **Anonymous Analytics Help Us Improve:** We use Google Analytics for Firebase to understand how the App is used (e.g., which games are most popular). This data is anonymous, aggregated, and helps us make the App better.
...
### 2. Data Handled by Third-Party Services
...
To provide relevant ads and support our App, we use the Google Mobile Ads SDK (AdMob). This includes banner advertisements and optional rewarded advertisements. The types of data AdMob may collect include:
...
We use Google Analytics for Firebase to collect anonymous, non-personal, and aggregated data about how you interact with our App. This helps us understand which features are popular, identify areas for improvement, and fix bugs. The data collected includes:

- **Events:** Such as starting or completing a game, using a feature (like sharing), or viewing a specific screen.
- **Device Attributes:** Such as device model, operating system, and country.
- **Crash Reports:** Anonymous information about app crashes to help us improve stability.

This data is completely anonymous and cannot be used to identify you personally. It is essential for us to maintain and enhance the App.

### 3. In-App Purchases, Rewards & Data Storage

- **One-Time Purchases (Premium Upgrade & Sticker Packs):** These are non-consumable items linked to your Google Account. Once purchased, they are yours to keep. They can be restored on any device where you are logged in with the same Google Account. The Premium upgrade also unlocks all purchasable sticker packs as part of its benefits.
...
- **Cloud Save (Optional):** If you sign in to Google Play Games, your progress (score, unlocked items, etc.) is automatically saved to the cloud. If you install the App on a new device and sign in with the same account, your progress will be restored. If there is a conflict between your local save and your cloud save, you will be prompted to choose which one to keep.
...
- For users identified as children, Google AdMob is configured to serve non-personalized (contextual) advertisements in accordance with their policies.
- The anonymous analytics data we collect via Firebase does not include any personally identifiable information.
...
The Application may allow you to purchase certain enhancements, such as a "Premium" upgrade or digital sticker packs ("In-App Purchases").

- **Purchases:** All In-App Purchases are processed through the Google Play Store and are subject to its terms and conditions. You agree to provide accurate and complete payment information to Google. We do not process or store any of your financial information. All purchases are final and non-refundable, except as required by applicable law or the policies of the Google Play Store. Refund requests must be directed to Google.

- **Virtual Items:** In-App Purchases may grant you access to virtual, in-app items such as sticker packs ("Virtual Items"). You acknowledge that these Virtual Items are granted to you as a limited, non-transferable, revocable license for use solely within the Application. **Virtual Items have no cash value, cannot be redeemed for real money or any other goods or services, and cannot be transferred or sold to any other person.**

- **Restoration:** Non-consumable In-App Purchases (like the Premium upgrade and sticker packs) are tied to your Google Account and can be restored on new or multiple devices, provided you are logged into the same Google Account used to make the purchase.

- **Advertisements:** The Application may display third-party advertisements. We may, at our discretion, offer temporary benefits (such as a 24-hour ad-free period) in exchange for viewing a rewarded advertisement. These benefits are not considered a purchase and are subject to change.
...
- Using the Application as part of any effort to compete with us or for any commercial enterprise.

### 5. Augmented Reality (AR) Safety Warning

**Your safety is your responsibility.** When using features that involve your device's camera, such as the Augmented Reality (AR) game, you must be aware of your physical surroundings at all times. Do not use the AR feature while walking in unsafe areas, near traffic, stairs, obstacles, or in any situation where your full attention is required for your safety and the safety of others. By using the AR feature, you agree that you are doing so at your own risk. We are not liable for any injury, damage to property, or any other loss that may occur while you are using the AR features of the Application.
